...
describe('Trino semantic context collector tests', () => {
    ...
    test('beginning of statement with uncomplete keyword', () => {
        ...
        const { isStatementBeginning } = trinoSql.getSemanticContextAtCaretPosition(sql, {
            lineNumber: 1,
            column: 5,
        });
    ...
    test('beginning of statement if previous token text is semicolon even if has error', () => {
        ...
        // typed keyword
        const ctx1 = trinoSql.getSemanticContextAtCaretPosition(sql, {
            lineNumber: 1,
            column: 13,
        });
        ...
        // typed white space
        const ctx2 = trinoSql.getSemanticContextAtCaretPosition(sql, {
            lineNumber: 1,
            column: 9,
        });
    ...
    test('test sqlSplitStrategy', () => {
        ...
        const { isStatementBeginning: isStatementBeginning1 } =
            trinoSql.getSemanticContextAtCaretPosition(
                sql,
                {
                    lineNumber: 2,
                    column: 7,
