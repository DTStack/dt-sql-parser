...
ALTER DATABASE inventory SET LOCATION 'file:/temp/sql-warehouse/new_inventory.db';
ALTER SCHEMA inventory SET LOCATION 'file:/temp/sql-warehouse/new_inventory.db';
ALTER NAMESPACE inventory SET LOCATION 'file:/temp/sql-warehouse/new_inventory.db';
