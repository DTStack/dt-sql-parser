// Generated from dt-sql-parser/src/grammar/basic/BasicSqlLexer.g4 by ANTLR 4.13.1
...
export class BasicSqlLexer extends antlr.Lexer {
    ...
    public constructor(input: antlr.CharStream) {
        super(input);
        this.interpreter = new antlr.LexerATNSimulator(this, BasicSqlLexer._ATN, BasicSqlLexer.decisionsToDFA, new antlr.PredictionContextCache());
    }

    public get grammarFileName(): string { return "BasicSqlLexer.g4"; }

    public get literalNames(): (string | null)[] { return BasicSqlLexer.literalNames; }
    public get symbolicNames(): (string | null)[] { return BasicSqlLexer.symbolicNames; }
    public get ruleNames(): string[] { return BasicSqlLexer.ruleNames; }

    public get serializedATN(): number[] { return BasicSqlLexer._serializedATN; }

    public get channelNames(): string[] { return BasicSqlLexer.channelNames; }

    public get modeNames(): string[] { return BasicSqlLexer.modeNames; }
    ...
    public static get _ATN(): antlr.ATN {
        if (!BasicSqlLexer.__ATN) {
            BasicSqlLexer.__ATN = new antlr.ATNDeserializer().deserialize(BasicSqlLexer._serializedATN);
        }

        return BasicSqlLexer.__ATN;
    }


    private static readonly vocabulary = new antlr.Vocabulary(BasicSqlLexer.literalNames, BasicSqlLexer.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return BasicSqlLexer.vocabulary;
    }

    private static readonly decisionsToDFA = BasicSqlLexer._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}