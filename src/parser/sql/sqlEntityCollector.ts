...
} from '../../lib/sql/SqlParser';
import type { SqlParserListener } from '../../lib/sql/SqlParserListener';
import { AttrName, EntityCollector, StmtContextType } from '../common/entityCollector';
import { EntityContextType } from '../common/types';

export class SqlEntityCollector extends EntityCollector implements SqlParserListener {
    /** ====== Entity Begin */
