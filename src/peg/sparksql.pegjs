...

{
  ...
  let legacy_setops_precedence_enbled = false;
  let partitions=[];
...
windowSpec
    ...
    / '('
      (  
        CLUSTER BY partition:expression (',' partition:expression {partitions.push(partition; return ',' + partition)})* 
