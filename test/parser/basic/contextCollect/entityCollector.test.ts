...
import { BasicSQL, BasicSqlSplitListener, BasicEntityCollector } from 'src/parser/basic';
import { ParseTreeListener } from 'antlr4ng';
import { BasicSqlParserListener } from 'src/lib/basic/BasicSqlParserListener';
...
describe('BasicSQL entity collector tests', () => {
    const basic = new BasicSQL();
    const parseTree = basic.parse(commonSql);
    const splitListener = new BasicSqlSplitListener();
    basic.listen(splitListener as BasicSqlParserListener, parseTree);

    test('validate common sql', () => {
        expect(basic.validate(commonSql).length).toBe(0);
    });
    ...
    test('create table like', () => {
        ...
        const collectListener = new BasicEntityCollector(commonSql);
        basic.listen(collectListener as ParseTreeListener, columnCreateTableContext);
    ...
    test('create data source table', () => {
        ...
        const collectListener = new BasicEntityCollector(commonSql);
        basic.listen(collectListener as ParseTreeListener, testingContext);
    ...
    test('create function', () => {
        ...
        const collectListener = new BasicEntityCollector(commonSql);
        basic.listen(collectListener as ParseTreeListener, functionContext);
