...
} from '../../lib/basic/BasicSqlParser';
import type { BasicSqlParserListener } from '../../lib/basic/BasicSqlParserListener';
import { EntityContextType } from '../common/types';
import { StmtContextType, EntityCollector } from '../common/entityCollector';

export class BasicEntityCollector extends EntityCollector implements BasicSqlParserListener {
    /** ====== Entity Begin */
