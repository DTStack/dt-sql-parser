...
describe('Sql entity collector tests', () => {
    ...
    test('create table like', () => {
        ...
        const collectListener = new SqlEntityCollector(commonSql);
    ...
    test('create data source table', () => {
        ...
        const collectListener = new SqlEntityCollector(commonSql);
        sql.listen(collectListener as ParseTreeListener, testingContext);
    ...
    test('create function', () => {
        ...
        const collectListener = new SqlEntityCollector(commonSql);
        sql.listen(collectListener as ParseTreeListener, functionContext);
