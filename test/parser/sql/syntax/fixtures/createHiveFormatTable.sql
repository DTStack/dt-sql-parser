...
CREATE EXTERNAL TABLE family (id INT, name STRING)
    ROW FORMAT SERDE 'com.ly.sql.serde.SerDeExample'
    STORED AS INPUTFORMAT 'com.ly.sql.example.serde.io.SerDeExampleInputFormat'
        OUTPUTFORMAT 'com.ly.sql.example.serde.io.SerDeExampleOutputFormat'
    LOCATION '/tmp/family/';
